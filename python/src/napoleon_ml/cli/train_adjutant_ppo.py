"""Train a adjutant Actor-Critic policy with PPO on non-playing RL samples."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        help="Optional supervised or actor-only adjutant checkpoint used to initialize the Actor.",
    )
...
def _handle_cli_error(error: Exception) -> int:
    if isinstance(error, AdjutantPpoCompatibilityError | ValueError):
