...
if MODEL_INPUT_SCHEMA_VERSION != PLAYING_MODEL_INPUT_SCHEMA_VERSION:
    raise AssertionError(
        "MODEL_INPUT_SCHEMA_VERSION must match PLAYING_MODEL_INPUT_SCHEMA_VERSION."
    )
...
_CONTRACT_TARGET_POINT_CARDS_CLASS_COUNT = (
    MAX_CONTRACT_TARGET_POINT_CARDS - MIN_CONTRACT_TARGET_POINT_CARDS + 1
)
...
if BIDDING_MODEL_INPUT_FEATURE_COUNT != 3755:
    raise AssertionError(
        f"BIDDING_MODEL_INPUT_FEATURE_COUNT must be 3755, got {BIDDING_MODEL_INPUT_FEATURE_COUNT}."
    )
if EXCHANGE_MODEL_INPUT_FEATURE_COUNT != 4081:
    raise AssertionError(
        "EXCHANGE_MODEL_INPUT_FEATURE_COUNT must be 4081, "
        f"got {EXCHANGE_MODEL_INPUT_FEATURE_COUNT}."
    )
if ADJUTANT_MODEL_INPUT_FEATURE_COUNT != 3963:
    raise AssertionError(
        "ADJUTANT_MODEL_INPUT_FEATURE_COUNT must be 3963, "
