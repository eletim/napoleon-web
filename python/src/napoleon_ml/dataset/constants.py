...
PLAYING_SELF_PLAY_BINARY_DATASET_FORMAT = "playing-self-play-binary-v1"
...
PLAYING_SELF_PLAY_DATASET_SCHEMA_VERSION = 4
PLAYING_SELF_PLAY_LEGACY_DATASET_SCHEMA_VERSION = 3
PLAYING_SELF_PLAY_DATASET_GENERATOR_VERSION = 1
PLAYING_SELF_PLAY_BINARY_SHARD_SCHEMA_VERSION = 1
PLAYING_SELF_PLAY_DATASET_SAMPLE_TYPE = "playing-self-play-sample"
PLAYING_SELF_PLAY_SAMPLE_SCHEMA_VERSION = 4
PLAYING_SELF_PLAY_LEGACY_SAMPLE_SCHEMA_VERSION = 3
...
COMPLETE_INFO_PLAYING_ENCODER_SCHEMA_VERSION = 1
PLAYING_MODEL_INPUT_SCHEMA_VERSION = 3
COMPLETE_INFO_PLAYING_MODEL_INPUT_SCHEMA_VERSION = 1
MODEL_INPUT_FEATURE_COUNT = 7653
COMPLETE_INFO_PLAYING_MODEL_INPUT_FEATURE_COUNT = 385
BIDDING_ENCODER_SCHEMA_VERSION = 2
EXCHANGE_ENCODER_SCHEMA_VERSION = 3
ADJUTANT_ENCODER_SCHEMA_VERSION = 2
...
PUBLIC_PLAYING_OBSERVATION_VARIANT = "public"
COMPLETE_INFO_COMPACT_PLAYING_OBSERVATION_VARIANT = "complete-info-compact"
PLAYING_OBSERVATION_VARIANTS = (
...
MIN_BIDDING_TARGET_POINT_CARDS = 10
...
MIN_CONTRACT_TARGET_POINT_CARDS = 9
